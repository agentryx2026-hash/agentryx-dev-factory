    ...
    (async () => {
      try {
        ...
        const SERVICES = [
          ...
          { id: 'hermes',     name: 'Hermes Agent (Lab)',    port: 9119, kind: 'http', check_url: 'http://127.0.0.1:9119/',                  console_url: 'https://dev-hub.agentryx.dev/hermes/',     has_console: true,  role: 'lab',     note: 'NousResearch Hermes Agent — Phase 2.75 Lab profile. Dashboard at /hermes/ (nginx sub_filter rewrites absolute /api/ + /assets/ paths). Container factory-hermes; evaluation-only, not yet adopted into pipeline.' },
