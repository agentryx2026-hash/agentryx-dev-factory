    ...
    (async () => {
      try {
        ...
        const SERVICES = [
          ...
          { id: 'litellm',    name: 'LiteLLM',               port: 4000, kind: 'http', check_url: 'http://127.0.0.1:4000/health/liveliness', console_url: 'https://dev-hub.agentryx.dev/litellm/ui',   has_console: true,  role: 'infra',   note: 'LLM proxy (own admin UI at /litellm/ui; nginx-proxied)' },
